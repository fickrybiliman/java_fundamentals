...
public class Exercise_03 {
    public static void main(String[] args) {
        ...
        System.out.print("Enter a number between 1 and 12 to know what months of the year : ");
        ...
        switch (number) {
            ...
            case 12:
                ...
                break;
            default:
                month = "You entered number " + number + " , Please enter a number between 1 and 12";
        }
